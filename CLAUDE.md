...
│   ├── add_connector.sh
│   ├── guides/
│   │   ├── patterns/                 # 30+ flow & payment-method pattern templates
│   │   ├── quality/                  # Quality Guardian rubric (score ≥ 60 required)
│   │   ├── feedback.md               # Captured lessons from past reviews
│   │   ├── learnings/                # Implementation lessons
│   │   └── types/types.md            # UCS type system reference
│   ├── connector_integration/template/   # Tech-spec & planner templates
│   └── references/                   # Per-connector spec output (gitignored)
