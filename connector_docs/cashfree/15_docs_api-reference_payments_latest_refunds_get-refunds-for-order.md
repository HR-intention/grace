...
<a
  href="https://www.postman.com/cashfreedevelopers/workspace/cashfree-apis-v2025-01-01/request/40140981-9c071097-0b45-4952-a03e-3b2abf3246cc"
  target="_blank"
...
````yaml /openapi/payments/v2025-01-01.yaml get /orders/{order_id}/refunds
openapi: 3.0.0
info:
  version: '2025-01-01'
  ...
  /orders/{order_id}/refunds:
    get:
      ...
      responses:
        '200':
          description: >-
            Success response for fetching all refunds processed against an
            order.
          content:
            application/json:
              schema:
