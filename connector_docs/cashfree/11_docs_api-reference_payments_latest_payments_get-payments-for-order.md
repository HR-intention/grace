...
<a
  href="https://www.postman.com/cashfreedevelopers/workspace/cashfree-apis-v2025-01-01/request/40140981-6548d3d4-dd09-4018-ae2a-25e2748a5f7a"
  target="_blank"
...
````yaml /openapi/payments/v2025-01-01.yaml get /orders/{order_id}/payments
openapi: 3.0.0
info:
  version: '2025-01-01'
...
paths:
  /orders/{order_id}/payments:
    get:
      ...
      responses:
        '200':
          description: Success response for viewing all payment details for an order.
          content:
            application/json:
              schema:
                type: array
                    ...
                    - auth_id: null
                      ...
                      error_details:
                        ...
                        error_description_raw: >-
                          AUTHENTICATION_FAILURE - (01 - Cardholder selected
                          Cancel)
                        error_subcode_raw: ''
                      international_payment:
                        international: false
                      ...
                      order_id: order_18482zuD6LhQGYO3OOihGjnlDV4OzpD
                      payment_amount: 1
                      payment_completion_time: '2025-07-15T15:01:49+05:30'
                      payment_currency: INR
                      payment_gateway_details:
                        gateway_name: CASHFREE
                        gateway_order_id: null
                        ...
                        gateway_reference_name: null
                      payment_group: debit_card
                      payment_message: Transaction Failed -  (01 - Cardholder selected Cancel)
                      payment_method:
                        card:
                          card_bank_name: KOTAK MAHINDRA BANK
                          card_country: IN
