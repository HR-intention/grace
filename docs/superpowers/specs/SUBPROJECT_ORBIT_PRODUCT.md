...
CREATE TABLE mandates (
    ...
    rail TEXT NOT NULL,                         -- UPI_AUTOPAY | CARD_EMANDATE
...
- Reconciliation via `sync_subscription` (housekeeping; §3.5.3).
