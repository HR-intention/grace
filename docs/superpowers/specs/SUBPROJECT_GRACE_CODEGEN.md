...
<sylibs>/packages/lens/src/lens/connectors/<psp>/
  ...
  subscriptions/         # domain: MandateConnector
    connector.py         # class <Psp>Subscriptions(_<Psp>Base, MandateConnector): 5 lifecycle + 2 plan-management (create_plan/change_plan) + 4 introspection
