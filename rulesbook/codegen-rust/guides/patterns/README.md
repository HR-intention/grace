...
Pattern files are organized as follows:

- **Flow patterns** live flat in this directory as `pattern_<flow>.md`.
- **Payment-method patterns** (Authorize flow only) live under `authorize/<category>/pattern_authorize_<category>.md`.
...
├── pattern_psync.md                # Payment status sync
├── pattern_void.md                 # Void/cancel
├── pattern_refund.md               # Refund flow
├── pattern_rsync.md                # Refund status sync
...
├── pattern_mandate_revoke.md       # Mandate revoke
├── pattern_payment_method_token.md # Payment method tokenization
├── pattern_createorder.md          # Multi-step payment initiation
├── pattern_session_token.md        # Session token
├── pattern_defend_dispute.md       # Defend dispute
├── pattern_accept_dispute.md       # Accept dispute
├── pattern_dsync.md                # Dispute status sync
├── pattern_submit_evidence.md      # Submit evidence
├── pattern_CreateAccessToken_flow.md
├── pattern_IncrementalAuthorization_flow.md
├── pattern_void_pc.md
└── authorize/                      # Payment-method patterns (authorize flow)
    ├── README.md
...
### Pattern Reference
- [`authorize/README.md`](./authorize/README.md) - Authorize payment-method patterns index
